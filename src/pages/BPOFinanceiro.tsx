...
const BPOFinanceiro = () => {
  ...
  const pacoteAvancado = [
    "Todos os serviços do Intermediário",
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {solucoes.map((solucao, index) => (
                <div key={index} className="bg-slate-900/50 border border-slate-700/50 rounded-2xl p-6 hover:bg-slate-800/50 transition-all duration-300">
                  <div className="w-12 h-12 bg-gradient-to-r from-orange-500 via-blue-500 to-green-500 rounded-xl flex items-center justify-center mb-4">
        ...
        <section className="py-16 px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              ...
              {/* Pacote Avançado */}
              <Card className="bg-slate-900/50 border-slate-700/50 hover:bg-slate-800/50 transition-all duration-300 relative">
                <div className="absolute top-4 right-4 bg-gradient-to-r from-green-500 to-green-600 text-white px-3 py-1 rounded-full text-sm font-medium">
                  Completo
                </div>
                <CardHeader className="text-center">
                  ...
                  <CardTitle className="text-2xl text-white">Avançado</CardTitle>
                  <CardDescription className="text-slate-400">
                    Gestão estratégica com consultoria
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <ul className="space-y-3">
                    {pacoteAvancado.map((item, index) => (
                      <li key={index} className="flex items-center gap-3 text-slate-300">
                  ...
                  <Button 
                    onClick={() => openWhatsApp("Pacote Avançado")}
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-gradient-to-r from-slate-800/50 to-slate-700/50 backdrop-blur-xl border border-slate-600/50 rounded-3xl p-8">
              ...
              <Button 
                ...
                className="bg-gradient-to-r from-orange-500 via-blue-500 to-green-500 hover:from-orange-600 hover:via-blue-600 hover:to-green-600 text-white px-10 py-5 text-xl rounded-full shadow-2xl transform hover:scale-105 transition-all duration-300"
              >
