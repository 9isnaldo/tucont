...
import { Users, Zap, TrendingUp, Crown, Shield, Target, ArrowRight, Sparkles, Building2, Bot } from "lucide-react";
...
const AgentesSection = () => {
  const benefits = [
    {
      icon: Building2,
      title: "Plataforma com esteira de conformidade pronta",
      description: "Acesso completo à nossa tecnologia de automação fiscal e contábil já validada"
    },
    {
      icon: Bot,
      title: "Acesso a ferramentas e IA integradas", 
      description: "Use nossa inteligência artificial e frameworks exclusivos em seus atendimentos"
    },
    {
      icon: Crown,
      title: "Modelo de atuação validado (estilo XP)",
      description: "Metodologia comprovada que transforma contadores em consultores estratégicos"
    },
    {
      icon: Shield,
      title: "Suporte, marca, método e comunidade",
  ...
  return (
    <section id="agentes" className="py-24 px-4 bg-tucont-secondary-gray relative overflow-hidden">
      {/* Background Effects */}
      <div className="absolute inset-0 bg-gradient-to-r from-tucont-orange/5 via-transparent to-tucont-royal/5"></div>
      <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-tucont-orange/10 rounded-full blur-3xl animate-pulse"></div>
