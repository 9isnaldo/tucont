...
import { Mail, MapPin, Instagram, Calculator } from "lucide-react";
...
const Footer = () => {
  ...
  return (
    <footer className="bg-slate-900/95 text-foreground">
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              <button onClick={openWhatsApp} className="w-12 h-12 bg-tucont-cta-green rounded-full flex items-center justify-center hover:bg-tucont-cta-green/90 transition-all duration-300 hover:shadow-lg hover:shadow-tucont-cta-green/25 hover:-translate-y-0.5">
                <img src="/lovable-uploads/whatsApp.svg" alt="Whatsapp" className="h-6" />
              </button>
          ...
          <div>
            <h3 className="font-semibold text-tucont-orange mb-6 text-lg">Soluções para Empresas</h3>
            <div className="space-y-3">
              <button 
                onClick={() => scrollToSection('solucoes')} 
                className="block text-muted-foreground hover:text-white transition-colors text-left"
              >
                Abertura de Empresa
              </button>
              <button 
              ...
              <Link to="/solucoes" className="block text-muted-foreground hover:text-white transition-colors">Ver todas as soluções</Link>
            </div>
          </div>

          {/* Para Contadores */}
          <div>
            <h3 className="font-semibold text-tucont-orange mb-6 text-lg">Para Contadores</h3>
            <div className="space-y-3">
              <button 
              ...
              <Link to="/parceiros" className="block text-muted-foreground hover:text-white transition-colors">Programa de Parceiros</Link>
              <Link to="/poder-contabil" className="block text-muted-foreground hover:text-white transition-colors">Poder Contábil</Link>
            </div>
          </div>

          {/* Contato */}
          <div>
            <h3 className="font-semibold text-tucont-orange mb-6 text-lg">Contato</h3>
            <div className="space-y-4">
